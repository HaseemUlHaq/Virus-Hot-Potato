...
public class UDPReceiver : MonoBehaviour
{
    ...
    void TryPulse()
    {
        GameObject virus = GameObject.Find("Virus_Shashank");
        Debug.Log("[UDP] Virus found: " + (virus != null));

        if (virus != null)
        {
            NetworkGrabbableVirus netVirus = 
                virus.GetComponent<NetworkGrabbableVirus>();
            ...
            {
                Debug.LogWarning("[UDP] NetworkGrabbableVirus not found!");
            }
        }
        else
        {
            Debug.LogWarning("[UDP] Virus_Shashank not found!");
        }
    }
